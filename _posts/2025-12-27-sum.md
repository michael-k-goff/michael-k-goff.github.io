...
author: Michael Goff
---
*This article is Version 2. Version 1 can be found [here](/2024-11-02-sum).*
...
## Origins of the Standard Model

[Alonso (1964)](http://dx.doi.org/10.4159/harvard.9780674730854), [Muth (1969)](https://www.scirp.org/reference/referencespapers?referenceid=1298808), and [Mills (1967)](https://www.jstor.org/stable/1821621) were all influenced by Johann von Thünen's *The Isolated State* ([von Thünen 1826](https://archive.org/details/isolatedstateeng0000thun)). Thünen's model is of the distribution of agricultural activity in a hypothetical state. The assumptions of the model are as follows.

- The state consists of only a single city.
- The city is surrounded by an endless expanse of agricultural land in all directions, and all land is equally suited to all forms of agricultural activity. There are no rivers, oceans, mountains, or other interruptions in the terrain.
- Farmers, who maximize profits, transport all goods to the central city. Thus transportation costs are proportional to the distance from the city.

Thünen finds that, under these highly simplifying assumptions, agricultural land around the city tends to organize into four rings. The cost of land decreases as one moves from the innermost to the outermost rings. The innermost ring consists of dairying and intensive agriculture, such as of fruits and vegetables. These commodities spoil quickly and thus have high transportation costs, and fruits and vegetables have high value relative to their land requirements. The second ring is dedicated to forestry, as timber and firewood are bulky and expensive to transport. The third ring is dedicated to staple crops such as grain, which are less bulky than timber and less perishable than dairy. The outermost ring is dedicated to ranching, for which transportation costs are low because livestock can self-transport.

[Von Thünen (1826)](https://archive.org/details/isolatedstateeng0000thun) predates refrigeration and motorized transportation, and many of its conclusions are not applicable to the modern world. Nevertheless, the ringed structure that follows from the model clearly influenced the development of the standard urban model, and the von Thünen model continues to be applied today. For example, [Han, Yuan, and Zou (2022)](https://doi.org/10.3390/land11111885) find that more intensive crops, such as dairy, fruits, and vegetables tend to be grown nearer large cities in China, while less intensive crops such as grains and livestock tend to be grown farther from cities.
...
Here, X₁ is the total production of goods, A₁ is a constant, and the three factors respectively are land, labor, and capital. The constant returns to scale assumption is equivalent to α₁ + β₁ + γ₁ = 1. By 1967, the concept of agglomeration was already well-established and discussed by Mills. The most significant agglomeration economy is *increasing returns to scale*, which manifests itself mathematically as α₁ + β₁ + γ₁ > 1.
...
In early work, [Clark (1951)](https://doi.org/10.2307/2981088) develops a model of a city's population density declining exponentially with distance from the central business district. The exponential model is chosen more for simplicity than mathematical precision.
...
## Changes in Cities over Time

Over the last few centuries, new technologies, especially transportation technology, have transformed the shape of cities. As discussed in [Anas, Arnott, and Small (1998)](https://www.jstor.org/stable/2564805), changing technological conditions pose a challenge to the Standard Urban Model because technology tends to change dramatically over the time scales that housing lasts. Changing modes of transportation from carriages to streetcars to private automobiles generally increase the speed of travel and would suggest that urban densities should decline over time. However, [Anas, Arnott, and Small (1998)](https://www.jstor.org/stable/2564805) note a countervailing effect: incomes rise over time, effectively increasing the time component of transportation, and thus leaving the effect of economic develop on urban densities ambiguous.

In the modern era, declining urban density has been the norm since the second half of the 20th century. [Xu et al. (2019)](https://doi.org/10.1016/j.landurbplan.2018.11.005) examine 35 large Chinese cities, excluding Beijing and Shanghai, from 2001 to 2015 and find that their density decreased at an average rate of 4.65% per year.

[Angel et al. (2010)](https://www.jstor.org/stable/resrep18335.3?seq=1) find that decreasing urban density is a widespread phenomenon. Using a combination of satellite imagery, census data, and historical maps, the authors study a global sample of 120 cities in high-, middle-, and low-income countries and find that from 1990 to 2000, they decreased in population density at an average rate of 2.0±0.4% per year. They also consider 20 United States cities from 1910 to 2000 and find that the average annual density decline rate over this period was 1.9%, or a factor of 5 decline over the 90 years. They also consider a subsample of 30 of the 120 global cities and examine historical population data from 1800 to 2000. The majority of these cities saw a density peak before 1900 and have decreased in density severalfold. They apply several regression models and find that more populous cities tend to have higher density, while cities with more buildable area, higher incomes, and greater income inequality tend to have lower densities.

[Harrison and Kain (1974)](https://doi.org/10.1016/0094-1190(74)90024-2) develop a model for city growth in which the broader technological environment changes along with the development of the city. In their model, residences represent long-lasted assets, and their structure reflects the time in which they are built. An inner ring of suburbs that was built before the availability of widespread automobile ownership, for instance, may have been built at a higher density than economics would have called for after widespread car ownership, but they will remain at a higher density for generations.
...
Anas, A., Arnott, R., Small, K. A. ["Urban Spatial Structure"](https://www.jstor.org/stable/2564805). Journal of Economic Literature **36**(3), pp. 1426-1464. September 1998.

Xu, G., Jiao, L., Yuan, M., Dong, T., Zhang, B., Du, C. ["How does urban population density decline over time? An exponential model for Chinese cities with international comparisons"](https://doi.org/10.1016/j.landurbplan.2018.11.005). Landscape and Urban Planning **183**, pp. 59-67. March 2019.

Angel, S., Parent, J., Civco, D.L., Blei, A. ["The Persistent Decline in Urban Densities: Global and Historical Evidence of'Sprawl'"](https://www.jstor.org/stable/resrep18335.3?seq=1) . Lincoln Institute of Land Policy. 2010.

Harrison, D. Jr., Kain, J.F. ["Cumulative urban growth and urban density functions"](https://doi.org/10.1016/0094-1190(74)90024-2). Journal of Urban Economics **1**(1), pp. 61-98. January 1974.

Von Thünen, J. H. *Der isolirte Staat in Beziehung auf Landwirtschaft und Nationalökonomie*. Wirtschaft & Finan. 1826. Translated by Warternberg, C. M. as [*The Isolated State*](https://archive.org/details/isolatedstateeng0000thun), 1966.

Han, H., Yuan, Z., Zou, K. ["Agricultural Location and Crop Choices in China: A Revisitation on Von Thünen Model"](https://doi.org/10.3390/land11111885). Land **11**(11), 1885. October 2022.